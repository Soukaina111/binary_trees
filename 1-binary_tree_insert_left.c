...
/**
 * binary_tree_insert_left -starts a function that inserts a node as the left-child of another node regarding the state of the parent if it is available or not
